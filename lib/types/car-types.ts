...
export const CAR_FIDELITY_TARGETS: Record<CarRenderMode, number> = {
  ...
  "stylized-luxury": 0.7, // 70% - Créativité maximale
} as const;

// Configuration de temperature pour Gemini selon le mode
export const CAR_GENERATION_CONFIG: Record<
  CarRenderMode,
  {
    temperature: number;
    topK: number;
...
export const CAR_MODE_DESCRIPTIONS: Record<
  CarRenderMode,
  {
    name: string;
    description: string;
...
> = {
  "perfect-clean": {
    ...
    description:
      "SHOWROOM PERFECTION - Comme une Mercedes neuve dans un showroom de luxe. Tapis ABSOLUMENT immaculés, surfaces impeccables, zéro poussière. Niveau de propreté 'jamais utilisé'.",
    useCase:
      "Services de nettoyage premium, photos showroom, annonces haut de gamme",
  },
  "enhanced-beauty": {
    name: "Enhanced Beauty",
    description:
      "Amélioration premium : éclairage optimisé, couleurs vibrantes et attractives, composition professionnelle. Style magazine haute gamme.",
    useCase:
      "Marketing immobilier premium, brochures, catalogues, présentations",
  },
  "stylized-luxury": {
    name: "Stylized Luxury",
    description:
      "Transformation créative : version de rêve de la voiture avec couleurs saturées, éclairage cinématique, esthétique aspirationnelle et conceptuelle.",
    useCase:
      "Social media, Pinterest, inspiration design, portfolio, lifestyle",
  },
} as const;
